...
from api.routes_no_cloudinary import router
...
def get_application() -> FastAPI:
    app = FastAPI(
        title="SmartRead API (No Cloudinary)",
        description="API for extracting and processing text from images using Mistral OCR - Local Storage Version",
        version="1.0.0",
        docs_url="/docs",
        redoc_url="/redoc",
    )
